...
@implementation MOTwoTableViewCell
{
    UIImageView *_iconView;
    UILabel *_nameLable;
    UILabel *_contentLabel;
    SDWeiXinPhotoContainerView *_picContainerView;//图片控制View
    UILabel *_timeLabel;
    UIButton *_moreButton;
    UIButton *_operationButton;
    SDTimeLineCellOperationMenu *_operationMenu; //点赞 和 评论 按钮的控制View
    SDTimeLineCellCommentView *_commentView;//评论内容 和 点赞人的控制View
